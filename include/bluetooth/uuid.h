 ...
 */
#define BT_UUID_PLX					BT_UUID_DECLARE_16(0x1822)
#define BT_UUID_PLX_VAL				0x1822
 ...
 *  @brief HTS Characteristic Measurement
 */
...
/** @def BT_UUID_PLX_SPOT_CHECK
 *  @brief PLX Spot-Check Measurement Characteristic
 */
#define BT_UUID_PLX_SPOT_CHECK			BT_UUID_DECLARE_16(0x2a5e)
#define BT_UUID_PLX_SPOT_CHECK_VAL		0x2a5e
/** @def BT_UUID_PLX_CONTINUOUS
 *  @brief PLX Continuous Measurement Characteristic
 */
#define BT_UUID_PLX_CONTINUOUS			BT_UUID_DECLARE_16(0x2a5f)
#define BT_UUID_PLX_CONTINUOUS_VAL		0x2a5f
/** @def BT_UUID_PLX_FEATURES
 *  @brief PLX Features Characteristic
 */
#define BT_UUID_PLX_FEATURES			BT_UUID_DECLARE_16(0x2a60)
#define BT_UUID_PLX_FEATURES_VAL		0x2a60
